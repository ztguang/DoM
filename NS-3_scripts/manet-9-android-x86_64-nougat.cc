...
int main (int argc, char *argv[])
{
  ...
  uint32_t numNodes = 9;  // by default, 3x3
  uint32_t sinkNode = 0;
...
//----------------------------------------------------------------------
  ...
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_6"));
  tapBridge.Install (adhocNodes.Get (5), adhocDevices.Get (5));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_7"));
  tapBridge.Install (adhocNodes.Get (6), adhocDevices.Get (6));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_8"));
  tapBridge.Install (adhocNodes.Get (7), adhocDevices.Get (7));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_9"));
