...
// scp manet-5-android-x86_64-nougat-4-if---in-one-node.cc 10.109.252.82:/opt/tools/network_simulators/ns3/ns-allinone-3.27/ns-3.27/scratch/

// ./waf --run scratch/manet-5-android-x86_64-nougat-4-if---in-one-node --vis
...
//*/
  ...
  //---------------------------------------------------------------------------------------------------- begin
  std::string phyMode3 ("DsssRate1Mbps");
