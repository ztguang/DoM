...
//*/
  ...
  // 这段管用
  //---------------------------------------------------------------------------------------------------- begin
  std::string phyMode2 ("DsssRate5_5Mbps");
  ...
  // 这段管用
  //---------------------------------------------------------------------------------------------------- begin
  std::string phyMode3 ("DsssRate2Mbps");
  ...
  // 这段管用
  //---------------------------------------------------------------------------------------------------- begin
  std::string phyMode4 ("DsssRate1Mbps");
...
//----------------------------------------------------------------------
  ...
  positionAlloc->Add (Vector (0, 50.0, 0.0));
  positionAlloc->Add (Vector (50, -50.0, 0.0));
...
//mobilityAdhoc.SetMobilityModel ("ns3::ConstantPositionMobilityModel");
  ...
  // set the first interface of the 8 nodes
  ...
  tapBridge.Install (adhocNodes.Get(2), adhocDevices_1.Get(2));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_40"));
  tapBridge.Install (adhocNodes.Get(3), adhocDevices_1.Get(3));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_50"));
  tapBridge.Install (adhocNodes.Get(4), adhocDevices_1.Get(4));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_60"));
  tapBridge.Install (adhocNodes.Get(5), adhocDevices_1.Get(5));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_70"));
  tapBridge.Install (adhocNodes.Get(6), adhocDevices_1.Get(6));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_80"));
  tapBridge.Install (adhocNodes.Get(7), adhocDevices_1.Get(7));

  // set the second interface of the 8 nodes
  ...
  tapBridge.Install (adhocNodes.Get(2), adhocDevices_2.Get(2));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_41"));
  tapBridge.Install (adhocNodes.Get(3), adhocDevices_2.Get(3));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_51"));
  tapBridge.Install (adhocNodes.Get(4), adhocDevices_2.Get(4));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_61"));
  tapBridge.Install (adhocNodes.Get(5), adhocDevices_2.Get(5));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_71"));
  tapBridge.Install (adhocNodes.Get(6), adhocDevices_2.Get(6));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_81"));
  tapBridge.Install (adhocNodes.Get(7), adhocDevices_2.Get(7));

  // set the third interface of the 8 nodes
  ...
  tapBridge.Install (adhocNodes.Get(2), adhocDevices_3.Get(2));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_42"));
  tapBridge.Install (adhocNodes.Get(3), adhocDevices_3.Get(3));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_52"));
  tapBridge.Install (adhocNodes.Get(4), adhocDevices_3.Get(4));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_62"));
  tapBridge.Install (adhocNodes.Get(5), adhocDevices_3.Get(5));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_72"));
  tapBridge.Install (adhocNodes.Get(6), adhocDevices_3.Get(6));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_82"));
  tapBridge.Install (adhocNodes.Get(7), adhocDevices_3.Get(7));

  // set the fourth interface of the 8 nodes
  ...
  tapBridge.Install (adhocNodes.Get(2), adhocDevices_4.Get(2));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_43"));
  tapBridge.Install (adhocNodes.Get(3), adhocDevices_4.Get(3));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_53"));
  tapBridge.Install (adhocNodes.Get(4), adhocDevices_4.Get(4));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_63"));
  tapBridge.Install (adhocNodes.Get(5), adhocDevices_4.Get(5));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_73"));
  tapBridge.Install (adhocNodes.Get(6), adhocDevices_4.Get(6));
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap_a_83"));
  tapBridge.Install (adhocNodes.Get(7), adhocDevices_4.Get(7));
