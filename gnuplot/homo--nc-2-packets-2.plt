# gnuplot homo--nc-2-packets-2.plt
# display homo--nc-2-packets-2.png &
# cp homo--nc-2-packets-2.png /root/桌面
# mv homo--nc-2-packets-2.png /root/桌面

#set terminal png truecolor
set term png font '/usr/share/fonts/msttcore/times.ttf,13'
set output "homo--nc-2-packets-2.png"
#set output "homo--nc-2-packets-2.eps"
...
plot 'homo--nc-2-packets-2.dat' using 1 with histogram ls 3
