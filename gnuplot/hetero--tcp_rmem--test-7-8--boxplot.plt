# gnuplot hetero--tcp_rmem--test-7-8--boxplot.plt
# display hetero--tcp_rmem--test-7-8--boxplot.png &
# cp hetero--tcp_rmem--test-7-8--boxplot.png /root/图片
# mv hetero--tcp_rmem--test-7-8--boxplot.png /root/图片

#set terminal png truecolor
set term png font '/usr/share/fonts/msttcore/times.ttf,13'
set output "hetero--tcp_rmem--test-7-8--boxplot.png"
#set output "hetero--tcp_rmem--test-7-8--boxplot.eps"
...
set key at 28.5,237 top Right samplen 2
...
#plot for [i=1:6] 'hetero--tcp_rmem--test-7-8--boxplot.dat' using (i):i notitle
plot 'hetero--tcp_rmem--test-7-8--boxplot.dat' \
	   using (1):1 title 'Time for Partflow-MPTCP-Markov-F-xIF-MDR' lt 3 lc 'blue',\
	'' using (2):2 title 'Time for Partflow-MPTCP-Markov-P-xIF-MDR' lt 3 lc 'light-cyan',\
	...
	'hetero--tcp_rmem--test-5678-odd--average.dat' using 1:4 axis x1y1 title "Average Time for Partflow-MPTCP-Markov-F-xIF-MDR" with lp pt 1 lc "navy", \
	'hetero--tcp_rmem--test-5678-even--average.dat' using 1:5 axis x1y1 title "Average Time for Partflow-MPTCP-Markov-P-xIF-MDR" with lp pt 3 lc "orange-red"
